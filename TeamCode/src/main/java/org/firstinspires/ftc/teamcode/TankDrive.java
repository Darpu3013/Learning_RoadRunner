...
public final class TankDrive {
    public static class Params {
        ...
        public double inPerTick = 0.02208521211005797368178890218091;
        public double trackWidthTicks = 775.9922469407935;

        // feedforward parameters (in tick units)
        public double kS = 1.3048206900773698;
        public double kV = 0.004649305383628598;
        public double kA = 0.00015;

        // path profile parameters (in inches)
        public double maxWheelVel = 37;
        ...
        public double ramseteZeta = 0.76; // in the range (0, 1)
        public double ramseteBBar = 1.5; // positive

        // turn controller gains
        public double turnGain = 0.06;
        public double turnVelGain = 0.03;
    }
